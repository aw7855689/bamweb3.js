...
class Sweb3 {
   ...
   * @param {number} blocks How many blocks are generated immediately.
   * @param {string} address The address to send the newly generated btcbam to.
   * @param {number} maxTries How many iterations to try (default = 1000000).
   * @return {array} Hashes of blocks generated.
   */
  ...
  /** ******** RAW TRANSACTIONS ********* */
  /**
   * Get the hex address of a Btcbam address.
   * @param {string} address Btcbam address
  ...
  /**
   * Converts a hex address to Btcbam address.
   * @param {string} hexAddress Btcbam address in hex format.
   * @return {Promise} Btcbam address or Error.
   */
  ...
  /** ******** UTIL ********* */
  /**
   * Validates if a valid Btcbam address.
   * @param {string} address Btcbam address to validate.
   ...
   * @param {string} address The Btcbam address for the private key.
  ...
  /**
   * Encrypts the wallet for the first time. This will shut down the Btcbam server.
  ...
  /**
   * Gets the account name associated with the Btcbam address.
   * @param {string} address The Btcbam address for account lookup.
  ...
  /**
   * Gets the Btcbam address based on the account name.
  ...
  /**
   * Gets the Btcbam address with the account name.
   * @param {string} acctName The account name ("" for default).
   * @return {Promise} Btcbam address array or Error.
   */
  ...
  /**
   * Gets a new Btcbam address for receiving payments.
   ...
   * @return {Promise} Array of addresses with Btcbam balances or Error.
   */
  ...
  /**
   * Lists unspent transaction outputs.
   * @param {string} address Address to send Btcbam to.
   * @param {number} amount Amount of BTCBAM to send.
   ...
   * @param {string} senderAddress The Btcbam address that will be used to send money from.
   ...
   * @param {bumber} amount The transaction fee in BTCBAM/kB.
