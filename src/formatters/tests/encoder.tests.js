...
describe('Encoder', () => {
  ...
  describe('addressToHex()', () => {
    it('should convert a btcbam address', () => {
      assert.equal(
  ...
  describe('validateMethodAndArgs()', () => {
    ...
    const args = ['bKjn4fStBaAtwGiwueJf9qFxgpbAvf1xAy', 'Hello World', ['a', 'b', 'c'], 'c350', 'c738'];
    ...
    it('throws if methodArgs does not match args in ABI', () => {
      assert.throws(() => Encoder.validateMethodAndArgs(abi, 'createTopic', ['bKjn4fStBaAtwGiwueJf9qFxgpbAvf1xAy', 'Hello World',
        ['a', 'b', 'c'], 'c350']), Error);
    });
  });
  ...
  describe('constructDataHex()', () => {
    ...
    it('throws if abi is undefined', () => {
      assert.throws(() => Encoder.constructData(undefined, 'test', ['bKjn4fStBaAtwGiwueJf9qFxgpbAvf1xAy', 'Hello World',
        ['a', 'b', 'c'], 'c350', 'c738']), Error);
    });

    it('throws if methodName is undefined', () => {
      assert.throws(() => Encoder.constructData(abi, undefined, ['bKjn4fStBaAtwGiwueJf9qFxgpbAvf1xAy', 'Hello World',
        ['a', 'b', 'c'], 'c350', 'c738']), Error);
    });
  });
});
